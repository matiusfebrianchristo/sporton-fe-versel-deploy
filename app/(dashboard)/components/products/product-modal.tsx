...
const ProductModal = ({product, onSuccess, isOpen, onClose}:TProductModalProps) => {
    ...
    const fetchCategories = async () => {
        try {
            ...
            console.log("Failed fetch to categories", err)
        }
    }
        ...
        <Modal isOpen={isOpen} onClose={onClose} title={isEditMode ? "Edit Product" : "Add New Product"}>
            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                    ...
                    <div className="flex flex-col gap-4 w-full">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="input-group-admin">
                                ...
                                <input type="number" id="price" name="price" value={formData.price} onChange={handleChange} placeholder="e. g. 200000" />
                            </div>
                            <div className="input-group-admin">
                                <label htmlFor="stock">Stock</label>
                                <input type="number" id="stock" name="stock" value={formData.stock} onChange={handleChange} placeholder="e. g. 100" />
                            </div>
                        </div>
                        <div className="input-group-admin">
                ...
                <div className="input-group-admin">
                    ...
                    <textarea name="description" id="description" rows={7} value={formData.description} onChange={handleChange} placeholder="Product Details..."></textarea>
                </div>
