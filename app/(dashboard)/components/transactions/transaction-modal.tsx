...
const TransactionModal = ({isOpen, onClose}:TTransactionModalProps) => {
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title="View Transactions">
            <div className="flex gap-6">
                <div>
                    <h4 className="font-semibold text-sm mb-2">Payment  Proof</h4>
                    <Image src="/images/payment-proof-dummy.png" alt="payment proof" width={200} height={401}></Image>
                </div>
                <div>
                    ...
                    <div className="bg-gray-100 rounded-md flex flex-col gap-2.5 p-4 text-sm mb-5">
                        <div className="flex justify-between font-medium">
                            ...
                            <div className="text-right">23/02/2026</div>
                        </div>
                        <div className="flex justify-between font-medium">
                            <div className="opacity-50">Customer</div>
                            <div className="text-right">Matius</div>
                        </div>
                        <div className="flex justify-between font-medium">
                            <div className="opacity-50">Contact</div>
                            <div className="text-right">123123123123</div>
                        </div>
                    ...
                    <div className="border border-gray-200 rounded-lg p-2 items-center flex gap-2">
                        <div className="bg-gray-100 rounded aspect-square w-8 h8">
                            <Image src='/images/products/product-1.png' width={30} height={30} alt="Product Image"></Image>
                        </div>
